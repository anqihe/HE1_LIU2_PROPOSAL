...
class MultiCohortOutcomes:
    def __init__(self):
        ...
        self.meanNumOfCOVID = []     # list of average patient time until AIDS from each simulated cohort
        ...
        self.statMeanNumCOVID = None      # summary statistics of average covid times
    ...
    def calculate_summary_stats(self):
        ...
        self.statMeanNumCOVID = Stat.SummaryStat(name='Average times of COVID',
                                                   data=self.meanNumOfCOVID)
